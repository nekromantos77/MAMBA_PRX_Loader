...
#elif defined(FIRMWARE_4_65) || defined(FIRMWARE_4_66) || defined(FIRMWARE_4_70) || defined(FIRMWARE_4_75) || defined(FIRMWARE_4_76) || defined(FIRMWARE_4_78) || defined(FIRMWARE_4_80) // the same as 4.65
