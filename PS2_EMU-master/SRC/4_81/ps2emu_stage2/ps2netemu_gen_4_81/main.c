...
#define read_iso_size_call	0x1360B8 //done
#define fstat_iso_call		0x135FAC //done
#define open_iso_call1		0x135F70 //done
#define open_iso_call2		0x136FF4 //done
#define savedata_patch		0x11B034 //done

#define ADDITIONAL_CODE_SIZE		0x46B0 //
#define ADDITIONAL_DATA_SIZE		0x1000

#define CODE_SECTION_ADDR		0x3800 //done
