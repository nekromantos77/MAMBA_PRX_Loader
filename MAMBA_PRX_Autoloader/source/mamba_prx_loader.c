...
#define MPL_PAYLOAD_PATH_2							"/dev_usb001/MAMBAPRXL/mpl_payload_%X.bin"
	...
	#define MAMBA_PAYLOAD_PATH_3					"/dev_hdd0/game/MAMBAPRXL/USRDIR/mamba/mamba_%X.bin"
	#define MPL_PAYLOAD_PATH_3						"/dev_hdd0/game/MAMBAPRXL/USRDIR/payloads/payload_%X.bin"

#endif

#define MAMBA_PAYLOAD_PATH_4						"/dev_hdd0/game/MAMBAPRXL/USRDIR/mamba/mamba_%X.bin"
#define MPL_PAYLOAD_PATH_4							"/dev_hdd0/game/MAMBAPRXL/USRDIR/payloads/payload_%X.bin"

#define MAMBA_PAYLOAD_PATH_5						"/dev_hdd0/game/MAMBAPRXL/USRDIR/payloads/mamba_%X.bin"
#define MPL_PAYLOAD_PATH_5							"/dev_hdd0/game/MAMBAPRXL/USRDIR/payloads/mpl_payload_%X.bin"

#define MAMBA_PAYLOAD_PATH_6						"/dev_hdd0/game/IRISMAN00/USRDIR/mamba/mamba_%X.bin"
#define MPL_PAYLOAD_PATH_6							"/dev_hdd0/game/IRISMAN00/USRDIR/payloads/payload_%X.bin"
			...
			if (file_exists(payload_path) != SUCCESS)
			{
				...
				if (file_exists(payload_path) != SUCCESS)
				{
					...
					if (file_exists(payload_path) != SUCCESS)
					{
						...
						if (file_exists(payload_path) != SUCCESS)
						{
							sprintf(payload_path, MAMBA_PAYLOAD_PATH_5, FIRMWARE);
							if (file_exists(payload_path) != SUCCESS)
							{
								sprintf(payload_path, MAMBA_PAYLOAD_PATH_6, FIRMWARE);
								if (file_exists(payload_path) != SUCCESS)
								{
									#ifdef ENABLE_LOG
									if (verbose) WriteToLog("Error: Unable to find MAMBA payload file\n");
