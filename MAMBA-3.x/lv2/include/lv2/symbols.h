...
#define umd_mutex_offset (0x64480+0x38C)
...
#if defined(FIRMWARE_480E) || defined(FIRMWARE_481E) || defined(FIRMWARE_482E) || defined(FIRMWARE_483E) || defined(FIRMWARE_484E)

	/* WIP: these offsets are a mix from 4.80 DEX and 4.78 DEH; they haven't been verified due the lack of a DECR system to test */

	#if defined(FIRMWARE_480E)
		#define FIRMWARE_VERSION                        0x480
	...
	/* vsh */
	#define ps2tonet_patch                              0xC9898
	#define ps2tonet_size_patch                         0xCA374
	#define vmode_patch_offset                          0x44D444
	#define psp_drm_patch1                              0x24A7E8
	#define psp_drm_patch2                              0x24B288
	#define psp_drm_patch3                              0x24AEC4
	#define psp_drm_patch4                              0x24B6D0
