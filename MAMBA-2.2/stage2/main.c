		...
		case SYSCALL8_OPCODE_PS3MAPI:
			switch ((int)param1)
			{
				...
				case PS3MAPI_OPCODE_GET_FW_VERSION:
					#if defined(FIRMWARE_4_65) || defined(FIRMWARE_4_66)
					return (lv1_peekd(0x80000000002FC938ULL+LV2_OFFSET_ON_LV1)==0x323031342F31312FULL)?0x0466:0x0465;
					#elif defined(FIRMWARE_4_65DEX) || defined(FIRMWARE_4_66DEX)
					return (lv1_peekd(0x800000000031EBA8ULL+LV2_OFFSET_ON_LV1)==0x323031342F31312FULL)?0x0466:0x0465;
					#elif defined(FIRMWARE_4_75) || defined(FIRMWARE_4_76) || defined(FIRMWARE_4_78) || defined(FIRMWARE_4_81) || defined(FIRMWARE_4_82)
					return (lv1_peekd(0x80000000002FCB68ULL+LV2_OFFSET_ON_LV1)==0x323031372F30382FULL)?0x0482:(lv1_peekd(0x80000000002FCB68ULL+LV2_OFFSET_ON_LV1)==0x323031362F31302FULL)?0x0481:(lv1_peekd(0x80000000002FCB68ULL+LV2_OFFSET_ON_LV1)==0x323031352F31322FULL)?0x0478:(lv1_peekd(0x80000000002FCB68ULL+LV2_OFFSET_ON_LV1)==0x323031352F30382FULL)?0x0476:0x0475;
					#elif defined(FIRMWARE_4_75DEX) || defined(FIRMWARE_4_76DEX) || defined(FIRMWARE_4_78DEX)
					return (lv1_peekd(0x800000000031EF48ULL+LV2_OFFSET_ON_LV1)==0x323031352F31322FULL)?0x0478:(lv1_peekd(0x800000000031EF48ULL+LV2_OFFSET_ON_LV1)==0x323031352F30382FULL)?0x0476:0x0475;
					#elif defined(FIRMWARE_4_75DEH) || defined(FIRMWARE_4_76DEH) || defined(FIRMWARE_4_78DEH)
					return (lv1_peekd(0x8000000000344B70ULL+LV2_OFFSET_ON_LV1)==0x323031352F31322FULL)?0x0478:(lv1_peekd(0x8000000000344B70ULL+LV2_OFFSET_ON_LV1)==0x323031352F30382FULL)?0x0476:0x0475;
					#elif defined(FIRMWARE_4_81DEX) || defined(FIRMWARE_4_82DEX)
					return (lv1_peekd(0x800000000031F028ULL+LV2_OFFSET_ON_LV1)==0x323031362F31302FULL)?0x0481:0x0482;
					#else
